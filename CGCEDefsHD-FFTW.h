...
const double h = 0.02;
const int FFTWGrain = 1201;//10;//39;//78; //Determines Q = 2*Pi*FFTWGrain/(h*ARRAY)
...
double NucScale=87;//400.;//8.//170.//120;//25.2;//18.;//1400.; //Scale of mu- probes different collision energies
